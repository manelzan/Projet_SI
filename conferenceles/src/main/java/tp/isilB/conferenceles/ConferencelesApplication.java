...
public class ConferencelesApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Conference conference1 = conferenceRepository.save(new Conference(null,"Conférence IA",LocalDate.of(2025, 12, 20), LocalDate.of(2025, 12, 25), "IA", "ouverte", editeur1 ,null));
